...
const handler = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (existingEmailsPath) {
        ...
        if (response.path) {
            ...
            console.log(`resolve(__dirname, "../init_template/")`, (0, path_1.resolve)(__dirname, "../init_template/"));
            yield (0, promises_1.cp)((0, path_1.resolve)(__dirname, "../init_template/emails"), response.path, {
                recursive: true,
            });

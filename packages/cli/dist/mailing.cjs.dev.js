...
function log(message) {
  ...
  (_console = console).log.apply(
    _console,
    [chalk__default["default"].blue("[mailing]"), message].concat(
      optionalParams
    )
  );
}
function error(message) {
  ...
  (_console2 = console).error.apply(
    _console2,
    [chalk__default["default"].red("[mailing]"), message].concat(optionalParams)
  );
}
...
function showIntercept(req, res) {
  ...
  var parts =
    (_req$url = req.url) === null || _req$url === void 0
      ? void 0
      : _req$url.split("/");
...
function showPreviewIndex(req, res) {
  ...
  var previewCollections = fsExtra
...
function showPreview(req, res) {
  ...
  if (component !== null && component !== void 0 && component.props) {
    ...
    var msg = ""
      .concat(functionName, "() from ")
      .concat(modulePath, " must return a react component defined in ")
      .concat(emailsPath);
    error(msg);
    res.writeHead(404);
    res.end(msg);
...
function _sendPreview() {
  _sendPreview = _asyncToGenerator(
            ...
            switch ((_context.prev = _context.next)) {
              ...
              case 42:
                ...
                if (
                  ...
                  error(
                    "sendMail not exported from ".concat(
                      path.resolve(previewsPath, "..")
                    )
                  );
                }
...
var handler$1 = /*#__PURE__*/ (function() {
  var _ref = _asyncToGenerator(
    /*#__PURE__*/ _regeneratorRuntime().mark(function _callee3(argv) {
      var port,
        dev,
        hostname,
        app,
        ...
        while (1) {
          switch ((_context3.prev = _context3.next)) {
            ...
            case 2:
              ...
              port =
                (argv === null || argv === void 0 ? void 0 : argv.port) ||
                DEFAULT_PORT;
                        ...
                        return _regeneratorRuntime().wrap(
                          function _callee$(_context) {
                            while (1) {
                              switch ((_context.prev = _context.next)) {
                                case 0:
                                  showShouldReload = function _showShouldReload(
                                    _req,
                                    res
                                  ) {
                                    res.writeHead(200);
                                ...
                                case 6:
                                  ...
                                  (pathname = parsedUrl.pathname),
                                    (query = parsedUrl.query); // Never cache anything
                                ...
                                case 32:
                                  if (
                                    !/^\/intercepts\/[a-zA-Z0-9]+\.json/.test(
                                      req.url
                                    )
                                  ) {
                                    _context.next = 36;
            ...
            case 24:
              ...
              log(
                "Watching for changes to ".concat(
                  path.relative(process$1.cwd(), changeWatchPath)
                )
              );
...
function _generateEmailsDirectory() {
  _generateEmailsDirectory = _asyncToGenerator(
        ...
        while (1) {
          switch ((_context.prev = _context.next)) {
            ...
            case 8:
              ...
              path$1 = "generator_templates/".concat(
                isTypescript ? "ts" : "js",
                "/emails"
              );
              _context.next = 13;
              return fsExtra.copySync(
                path.resolve(__dirname, path$1),
                response.path,
                {
                  overwrite: false,
                }
            ...
            case 13:
              log(
                "Generated your emails dir at "
                  .concat(response.path, ":\n")
...
function looksLikeTypescriptProject() {
  ...
  return !!(
    ((_pkg$devDependencies = pkg.devDependencies) !== null &&
      _pkg$devDependencies !== void 0 &&
      _pkg$devDependencies.typescript) ||
    ((_pkg$dependencies = pkg.dependencies) !== null &&
      _pkg$dependencies !== void 0 &&
      _pkg$dependencies.typescript)
  );
}
...
var handler = /*#__PURE__*/ (function() {
  var _ref = _asyncToGenerator(
    /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(args) {
      var ts, options;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch ((_context.prev = _context.next)) {
...
yargs__default["default"](process.argv.slice(2))
  .command(preview)
  .command(init)
  .help().argv;

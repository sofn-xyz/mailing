...
- remix_ts (React Router / Remix with Typescript)
...
- `--app=next_ts` to run the tests only on the specified framework. See `e2e/app.rb` for the list of supported frameworks

...
### _[Demo deployment](http://demo.mailing.run/previews/AccountCreated/accountCreated)_

### Why deploy?

- Share previews with clients and your team
- Email service with [REST API]()
  - /api/render renders templates and returns HTML
  - [Coming soon] /api/sendMail sends email using your sendMail from emails/index.ts

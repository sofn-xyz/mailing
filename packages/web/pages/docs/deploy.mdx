...
Your Mailing server can be deployed as a production website ([example](http://demo.mailing.run/previews/Welcome/preview)). The production build excludes development features like livereload and is optimized for performance.

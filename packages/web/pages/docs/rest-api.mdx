...
To get an API key, either [set up a database](https://www.mailing.run/docs/deploy#adding-a-database) and log in (recommended) or set the `MAILING_API_KEY` environment variable in your deployment environment to your desired key.

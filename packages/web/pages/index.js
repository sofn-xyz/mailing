...
export default function Home() {
  return (
    <div className={`w-screen h-screen bg-cover ${styles.container}`}>
      <Head>
      ...
      <div className="px-6 sm:px-12 max-w-6xl m-auto">
        <header className="flex justify-between items-top pt-32 pb-24">
          <div className="brand">
        ...
        <main className={styles.main}>
          <h1 className="text-4xl sm:text-8xl m-0 max-w-xs sm:max-w-3xl">
          ...
          <a
            className="bg-black text-white sm:text-3xl text-2xl leading-none px-12 py-6 block rounded-sm hover:underline absolute sm:static w-100 sm:w-fit right-[24px] bottom-[48px] left-[24px] text-center"
